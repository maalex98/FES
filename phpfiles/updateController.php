...
if(isset($_POST["addProduct"])){
	$sql = "INSERT INTO products (type, name, price, image_path, gender, event, season, style, brand, color, trends, description) VALUES ('".$_POST["type"]."','".$_POST["name"]."', '".$_POST["price"]."','".$_POST["image_path"]."','".$_POST["gender"]."','".$_POST["event"]."' ,'".$_POST["season"]."','".$_POST["style"]."','".$_POST["brand"]."','".$_POST["color"]."','".$_POST["trends"]."','.')";
	$result=mysqli_query($conn,$sql);
	header("location:../admin.php?page=products");
